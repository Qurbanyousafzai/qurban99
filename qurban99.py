...
\033[1;92m ┈┈┈▕▕╲┊┊╱▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕╲┊┊╱▏▏┈┈┈
\033[1;92m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;92m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;96mQuRBaNyoUsafZai.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;92m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;92m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;92m................\033[1;96mQuRBaN YouSaFzai\033[1;91m...............
\033[1;92m................\033[1;96m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : Qurban Yousafzai✅
\033[1;92m☞ WhatsApp   : 0309*****
\033[1;95m☞ YouTube    : https://www.youtube.com/channel/UC9ocjdQ-ILcBd3DdXsm4mbQ
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update QuRBaN Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' QuRBan Yousafzai WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('cd $HOME && git clone https://github.com/Qurbanyousafzai')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 0309*******✓')
	    psb('WellCome To QurBan Hacking WoRLD')
	    psb('Congratulations QuRBaN Tools Has Been Updated Successfully')
	    psb('🔓User Name☆ qurban✓')
	    psb('🔓Password ☆ qurban✓')
	    psb('Subscrib My Youtube Chenal Technical Wahab✓')
...
def pak():
	...
	cb()
	print (logo)
	print (S + '[' + P + '☞1' + S + ']' + P + ' Hack With Friend List')
	print (S + '[' + P + '☞2' + S + ']' + P + ' Hack From Public Account')
	print (S + '[' + Y + '☞3' + S + ']' + Y + ' Hack From File')
